const words = [
  "ninja", "spade", "pools", "drive", "relax", "times", "train", "cores", "pours", "blame",
  "banks", "phone", "bling", "coins", "hello", "there", "world", "react", "paint", "music",
  "party", "piano", "happy", "flute", "water", "ocean", "bread", "toast", "salad", "glass",
  "house", "mouse", "stone", "money", "books", "chair", "table", "light", "power", "night",
  "paper", "sound", "cloud", "focus", "above", "alike", "array", "begin", "berry", "block",
  "bring", "build", "camel", "cause", "chest", "chief", "child", "china", "claim", "class",
  "clock", "coach", "coast", "court", "cover", "cream", "crime", "cross", "crowd", "crown",
  "curve", "cycle", "daily", "dance", "dated", "dealt", "death", "debut", "delay", "depth",
  "doing", "doubt", "dozen", "draft", "drama", "dream", "dress", "drill", "drink", "drive",
